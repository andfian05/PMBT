        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                    <li><a class="nav-link me-lg-3" href="https://petik-jombang.vercel.app/" target="_blank">Profil
                            PeTIK Jombang</a></li>
                ...
                <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0 rounded-pill"
                    href="{{ url('/pmbpetikjombang') }}"> <i class="fa-solid fa-graduation-cap"></i>&nbsp;Daftar
                    Sekarang</a>&nbsp;
                <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0 rounded-pill"
            ...
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="mb-4 mb-lg-0 text-center text-lg-start">
                        ...
                        <p class="lead fw-normal text-muted mb-3">Penerimaan Mahasantri Baru Tahun Angkatan 2023/2024.
                        </p>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="masthead-device-mockup">
                        ...
                        <circle cx="50" cy="50" r="50"></circle></svg><svg class="shape-1 d-none d-sm-block"
                            viewBox="0 0 240.83 240.83" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                <div class="screen bg-black">
                                    ...
                                    <video muted="" autoplay="" loop="" style="max-width: 100%; height: 100%">
                                        <source src="{{asset('assets2/assets/img/profil2.mp4')}}" type="video/mp4" />
                                        </video>
                                </div>
                            </div>
                        </div>
    ...
    <aside class="text-center bg-gradient-primary-to-secondary">
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-12">
                    <div class="h5 fs-1 text-white mb-4">
                        <h5>"Pencetak Mahasantri Berakhlak Mulia Dan Ahli Teknologi."</h5>
                    </div>
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                <div class="col-12 col-lg-5 mb-5">
                    ...
                    <p class="lead mb-5 mb-lg-0">Syarat dan Ketentuan Calon Mahasantri Pesantren PeTIK Jombang sebagai
                        berikut :</p><br>
                    <ul>
                        <li><b>Antusias Tinggi</b>, untuk mempelajari teknologi informasi dan komunikasi (Jurusan
                            Pengembangan Perangkat Lunak Atau Digital Marketing)</li>
                        <li>Berasal dari<b>Keluarga dengan perekonomian terbatas</b> (Dhuafa).</li>
                        <li>Dikhususkan untuk <b>Laki-laki Muslim</b> dengan lulusan <b>(SMA / SMK / MA)</b> Tahun
                            <b>2021,2022,2023</b> .</li>
                        <li><b>Sehat</b> Jasmani Dan Rohani.</li>
                        <li>Mampu <b>Membaca Al Qur’an</b> dengan Baik Dan Bersedia menambah Hafalan Al Qur'an minimal 2
                            Juz.</li>
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                ...
                <div class="col-sm-9 col-md-6">
                    ...
                    <ul>
                        <li><b>Surat Keterangan Tidak Mampu (SKTM)</b> dari pihak Kelurahan Atau <b>Kartu Indonesia
                                Pintar (KIP)</b> atau Surat Resmi Sejenis yang menunjukkan bahwa berasal dari Keluarga
                            Kurang Mampu.</li>
                        <li><b>Surat Keterangan Sehat Dari PUSKESMAS</b> atau <b>Klinik</b> setempat.</li>
                        <li><b>Salinan Kartu Keluarga</b> dan <b>Kartu Tanda Penduduk</b> atau <b>Kartu Pelajar</b>.
                        </li>
                        <li><b>Salinan Ijazah (SMA / SMK / MA)</b> atau <b> Surat Keterangan Aktif (SMA / SMK / MA)</b>
                            dari Pihak Sekolah (Jika Belum Memiliki Ijazah).</li>
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                <div class="col-12 col-lg-5 mb-5">
                    ...
                    <p class="lead mb-5 mb-lg-0">Alur Pendaftaran Calon Mahasantri Pesantren PeTIK Jombang sebagai
                        berikut :</p><br>
                    <ul>
                        <li>Siapkan berkas-berkas persyaratan yang telah ditentukan.</li>
                        <li>Mengisi formulir pendaftaran secara online dengan akses link <b>pmbpetikjombang.com</b> atau
                            dengan melalui 2 cara :
                            <ul>
                                <li>Upload berkas secara online dalam bentuk <b>scan format (JPG / PNG / PDF)</b>
                                    melalui link akses <b>pmbpetikjombang.com</b> atau menggunakan via Email :
                                    <b>petikjombang@gmail.com</b> .</li>
                                <li>atau bisa kirim dengan kurir atau datang langsung ke alamat ini <b>Pesantren
                                        Teknologi Informasi Dan Komunikasi YBM PLN, Plosogeneng, Jombang, Kec. Jombang,
                                        Jawa Timur 61416</b> .</li>
                            </ul>
                        </li>
                        <li>Calon Mahasantri yang sudah mengisi formulir pendaftaran akan dimasukkan ke dalam Grup
                            Whatsapp <b>“Pendaftar PeTIK 2023/2024”</b> .</li>
                        <li><b>Verifikasi Panitia</b> , Panitia akan mengumumkan Hasil Seleksi melalui Website dan Grup
                            Whatsapp.</li>
                        <li><b>Batas pengisian formulir dan penyerahan berkas</b> persyaratan paling lambat tanggal
                            <b>30 Juni 2023</b>.</li>
                        <li>Pendaftaran terbagi menjadi dua gelombang, pada Gelombang Pertama dilakukan pada tanggal
                            <b>15 Desember 2022 - 15 Maret 2023</b> . Pada Gelombang Kedua akan dilakukan pada tanggal
                            <b>16 Maret 2023 - 30 Juni 2023</b> .</li>
                    </ul>
                </div>
                <div class="col-sm-9 col-md-6">
                    <!-- <div class="px-5 px-sm-0"><img class="img-fluid rounded-circle" src="{{asset('foto/Group_2.svg' )}}"  height="95%" width="119%" alt="..." /></div> -->
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                ...
                <div class="col-sm-9 col-md-6">
                    ...
                    <p class="lead mb-5 mb-lg-0">Siapkan berkas persyaratan dan silahkan isi formulir pendaftaran dalam
                        link <b><a href="{{ url('/pmbpetikjombang') }}" target="_blank">pmbpetikjombang.com</a></b>.</p>
                    <br>
                    <p class="lead mb-5 mb-lg-0"><b>Catatan</b> :
                        Bagi yang akan mengirimkan berkas via online maka diharapkan menyiapkan semua berkas yang
                        dibutuhkan terlebih dahulu dalam bentuk .PDF atau .JPG sebelum mengisi formulir. Bagi yang akan
                        mengirimkan berkas via email atau jasa kirim maka dipersilakan isi formulir terlebih dahulu
                        kemudian kirimkan berkas tersebut pada alamat Pesantren.</p>
                    <br>
                    <p class="lead mb-5 mb-lg-0"> Formulir pendaftaran : PMBT Pesantren PeTIK Jombang akan ditutup pada tanggal
                        <b>30 Juni 2023</b></p>
