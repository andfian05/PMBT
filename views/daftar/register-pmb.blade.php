...
<body id="page-top">
              ...
              function tampilkan() {
                ...
                if (pesan == "online") {
                  p_kontainer.innerHTML = `
                    <div class="form-group">
                      <label class="col-12 mt-3">Silahkan Upload Semua Berkas Persyaratan Yang Telah Ditentukan, Lalu Jadikan Satu File Berbentuk .PDF, atau .Word, atau .Rar, atau .ZIP :</label>
                      <div class="col-12">
                        <ol>
                  ...
                  p_kontainer.innerHTML = `
                    <div class="form-group">
                      ...
                      <br>
                      <input name="berkas" type="file" class="form-control" value="{{ old('berkas') }}" multiple>
                      <label class="col-12 mt-3">* Silahkan upload bukti foto pengiriman berkas anda.</label>
                    </div>
                    `;
                } else if (pesan == "email") {
                  p_kontainer.innerHTML = `
                    <div class="form-group">
                      ...
                      <br>
                      <input name="berkas" type="file" class="form-control" value="{{ old('berkas') }}" multiple>
                      <label class="col-12 mt-3">* Silahkan upload bukti foto/screenshot pengiriman email berkas anda.</label>
                    </div>
                    `;
                }
              }
    ...
    <!-- <span>Mohon cantumkan bukti pengiriman</span> -->