...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="{{asset('foto/LG.png')}} " alt="AdminLTE Logo" class="brand-image img-box elevation-3"
            style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                ...
                <!-- <a class="btn bg-warning-emphasis px-3 mb-2 mb-lg-0" title="Role Akun" href=""><i
                        class="fa-solid fa-user-shield fa-2x"></i>&nbsp;</a>

                <br>

                <a class="btn bg-warning-emphasis px-3 mb-2 mb-lg-0" title="Keluar Akun"
                    href="{{ __('Logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i
                        class="fa-solid fa-right-from-bracket fa-2x"></i>&nbsp;{{ __('Logout') }}</a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('dataseleksi.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>DTR</p>
                            </a>
                        </li>
