        ...
        <div class="card card-info">
            ...
            {{-- Pengetahuan --}}
                    <div class="container mt-3 col-md-6">
                        <div class="card">
                            <div class="bg-info ">
                                <h6 class="text-center mt-2 ">Pengetahuan Seputar PeTIK Jombang</h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form mb-3 mb-md-0">
                            <label for="profil">Pengetahuan Seputar PeTIK Jombang </label>
                            <textarea name="keterangan" class="form-control" cols="2" rows="2" disabled>
                            {{ $mahasantri->profil->keterangan }}
                            </textarea>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="nama" id="nama" type="text"
                                    value="{{ $mahasantri->nama }}" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                <label for="anak_ke">Anak Ke- </label>
                                <input class="form-control" name="anak_ke" id="anak_ke" type="text"
                                    value="{{ $mahasantri->anak_ke }}" disabled />
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="tmp_lahir" type="text"
                                    value="{{ $mahasantri->tmp_lahir }}" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                ...
                                <input class="form-control" name="tgl_lahir" type="date"
                                    value="{{ $mahasantri->tgl_lahir }}" disabled />
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="no_hp" type="text" value="{{ $mahasantri->no_hp }}"
                                    disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                <label>Email </label>
                                <input class="form-control" name="email" type="email" value="{{ $mahasantri->email }}"
                                    disabled />
                            </div>
                        </div>
                    </div>
                ...
                {{ $mahasantri->alamat }}
                            ...
                            <div class="form mb-3 mb-md-0">
                                ...
                                <div class="form-group -ml-3col-12">
                                    <select name="prov_id" id="provinsi" class="custom-select" disabled>
                                        <option value="{{ $mahasantri->provinsi->id_prov }}">
                                            {{ $mahasantri->provinsi->nama }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form">
                                ...
                                <div class="form-group -ml-3col-12">
                                    <select name="kab_id" id="kabupaten" class="custom-select" disabled>
                                        <option value="{{ $mahasantri->kabupaten->id_kab }}">
                                            {{ $mahasantri->kabupaten->nama }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form mb-3 mb-md-0">
                                ...
                                <div class="form-group -ml-3col-12">
                                    <select name="kec_id" id="kecamatan" class="custom-select" disabled>
                                        <option value="{{ $mahasantri->kecamatan->id_kec }}">
                                            {{ $mahasantri->kecamatan->nama }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form">
                                ...
                                <div class="form-group -ml-3col-12">
                                    <select name="desa_id" id="desa" class="custom-select" disabled>
                                        <option value="{{ $mahasantri->desa->id_desa }}">{{ $mahasantri->desa->nama }}
                                        </option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="nama_ayah" type="text" value="{{ $mahasantri->nama_ayah }}"
                            disabled />
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="pkj_ayah" type="text"
                                    value="{{ $mahasantri->pkj_ayah }}" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                ...
                                <input class="form-control" name="pdk_ayah" type="text"
                                    value="{{ $mahasantri->pdk_ayah }}" disabled />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Nama Ibu </label>
                        <input class="form-control" name="nama_ibu" type="text" value="{{ $mahasantri->nama_ibu }}"
                            disabled />
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="pkj_ibu" type="text"
                                    value="{{ $mahasantri->pkj_ibu }}" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                ...
                                <input class="form-control" name="pdk_ibu" type="text"
                                    value="{{ $mahasantri->pdk_ibu }}" disabled />
                            </div>
                        </div>
                    </div>
                    <div class="row mb-1">
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="jml_sdr" type="text"
                                    value="{{ $mahasantri->jml_sdr }}" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                ...
                                <input class="form-control" name="nohp_klg" type="text"
                                    value="{{ $mahasantri->nohp_klg }}" disabled />
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="skl_asal" type="text" value="{{ $mahasantri->skl_asal }}"
                            disabled />
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="jurusan_skl" type="text"
                                    value="{{ $mahasantri->jurusan_skl }}" disabled />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                ...
                                <input class="form-control" name="thn_lulus" type="text"
                                    value="{{ $mahasantri->thn_lulus }}" disabled />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                {{ $mahasantri->cita_cita }}
                            ...
                            <div class="form mb-3 mb-md-0">
                                ...
                                <div class="form-group -ml-3col-12">
                                    <select name="jurusan_id" class="custom-select" disabled>
                                        <option value="{{ $mahasantri->jurusan->id_jurusan }}" selected>
                                            {{ $mahasantri->jurusan->nama_jurusan }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group -ml-3col-12">
                            <select name="media_id" class="custom-select" disabled>
                                <option value="{{ $mahasantri->mediaInformasi->id_media }}" selected>
                                    {{ $mahasantri->mediaInformasi->media_informasi }}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            ...
                            <a href="{{ storage_path('app/upload') }}/{{ $mahasantri->berkas }}">{{ $mahasantri->berkas }}</a>
                        </div>
                    </div>
                </div>
            </div>
