            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    ...
                    <div class="col-sm-9 col-md-6">
                        ...
                        <p class="lead mb-5 mb-lg-0">Siapkan Berkas Persyaratan Dan Silahkan Isi Formulir Pendaftaran Dalam Link <b><a href="{{ url('/pmbpetikjombang') }}">pmbtpetikjombang.com</a></b>.</p>
                        <br>
