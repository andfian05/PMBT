                    ...
                    <div class="col-12 col-lg-5 mb-5">
                        ...
                        <ul>
                            ...
                            <li>Mengisi Formulir Pendaftaran Secara Online Dengan Akses Link <b>pmbpetikjombang.com</b> Atau Dengan Melalui 2 Cara :
                                <ul>
                                    <li>Upload Berkas Secara Online Dalam Bentuk <b>Scan Format (JPG / PNG / PDF)</b>, Lalu Disatukan Menjadi <b>Format (ZIP Atau RAR)</b> Dengan <b>Nama Folder (Nama_Lengkap)</b>  Melalui Link Akses <b>pmbpetikjombang.com</b>  Atau Menggunakan via Email : <b>petikjombang@gmail.com</b> .</li>
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    ...
                    <div class="col-sm-9 col-md-6">
                        ...
                        <p class="lead mb-5 mb-lg-0">Siapkan Berkas Persyaratan Dan Silahkan Isi Formulir Pendaftaran Dalam Link <b><a href="{{ url('/pmbpetikjombang') }}" target="_blank">pmbpetikjombang.com</a></b>.</p>
                        <br>
                        <p class="lead mb-5 mb-lg-0"><b>Catatan</b>  :
                        Bagi Yang Akan Mengirimkan Berkas Via Online Maka Diharapkan Menyiapkan Semua Berkas Yang Dibutuhkan Terlebih Dahulu Dalam Bentuk (JPG / PNG / PDF) Lalu Disatukan Menjadi Format (ZIP Atau RAR) Dengan Nama Folder (Nama Lengkap) Sebelum Mengisi Formulir. Bagi Yang Akan Mengirimkan Berkas Via Email Atau Jasa Kirim Maka Dipersilakan Isi Formulir Terlebih Dahulu Dan Foto Bukti Pengiriman Untuk Upload Berkas, Kemudian Kirimkan Berkas Tersebut Pada Alamat Pesantren.</p>
                        <br>
