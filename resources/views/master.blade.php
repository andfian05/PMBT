                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                   ...
                   <!-- <button class="btn btn-primary bg-gradient-primary-to-secondary rounded-pill px-3 mb-2 mb-lg-0" data-bs-toggle="#" data-bs-target="#" href="https://www.instagram.com/petik_jombang/" target="_blank">
                        <span class="d-flex align-items-center"> -->
                            ...
                            <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0 rounded-pill" href="https://drive.google.com/file/d/18h-YZAjQh93j9QkPralRgCQa6gEyvRPW/view?usp=sharing" target="_blank"> <i class="fa-solid fa-cloud-arrow-down"></i>&nbsp;Download Brosur</a>
                ...
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    <div class="col-12 col-lg-5 mb-5">
                        ...
                        <ul>
                            ...
                            <li>Mengisi Formulir Pendaftaran Secara Online Dengan Akses Link <b>pmb.petikjombang.com</b> Atau Dengan Melalui 2 Cara :
                                <ul>
                                    <li>Upload Berkas Secara Online Dalam Bentuk <b>Scan Format (JPG / PNG / PDF)</b>, Lalu Disatukan Menjadi <b>Format (ZIP Atau RAR)</b> Dengan <b>Nama Folder (Nama_Lengkap)</b>  Melalui Link Akses <b>pmb.petikjombang.com</b>  Atau Menggunakan via Email : <b>pmb.petikjombang@gmail.com</b> .</li>
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    ...
                    <div class="col-sm-9 col-md-6">
                        ...
                        Bagi Yang Akan Mengirimkan Berkas Via Online Maka Diharapkan Menyiapkan Semua Berkas Yang Dibutuhkan Terlebih Dahulu Dalam Bentuk (JPG / PNG / PDF) Lalu Disatukan Menjadi Format (ZIP Atau RAR) Dengan Nama Folder (NamaLengkap) Sebelum Mengisi Formulir. Bagi Yang Akan Mengirimkan Berkas Via Email Atau Jasa Kirim Maka Diwajibkan Mengisi Formulir Terlebih Dahulu Dan Upload Foto Bukti Pengiriman Untuk Pada Formulir, Kemudian Kirimkan Berkas Tersebut Pada Alamat Pesantren.</p>
                        <br>
                        <p class="lead mb-5 mb-lg-0"> Formulir Pendaftaran : PMB Pesantren PeTIK Jombang akan ditutup pada tanggal <b>30 Juni 2023</b></p>
