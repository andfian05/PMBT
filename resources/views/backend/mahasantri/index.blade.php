        ...
        <div class="card">
            <div class="card-header">
                <a class="btn btn-primary px-3 mb-2 mb-lg-0" title="Tambah Biodata Mahasantri"
                    href="{{ route('mahasantri.create') }}">
                    <i class="fa-solid fa-circle-plus"></i>&nbsp;Add Data
                </a>
                <a class="btn btn-secondary px-3 mb-2 mb-lg-0" title="Export PDF Biodata Mahasantri" href="">
                    <i class="fa-solid fa-file-pdf"></i>&nbsp; .PDF
                </a>
                <a class="btn btn-secondary px-3 mb-2 mb-lg-0" title="Export Excel Biodata Mahasantri" href="">
                        ...
                        <tr>
                            ...
                            <td class="text-center d-flex">
                                <a class="btn btn-primary btn-sm me-2"
                                    href="{{ route('mahasantri.show', $mahasantri->id) }}">Detail</a>
                                <a class="btn btn-success btn-sm me-2"
                                    href="{{ route('mahasantri.edit', $mahasantri->id) }}">Update</a>
