    ...
    <div class="container">
        <div class="card card-info">
            ...
            <div class="card-body">
                ...
                <form id="form1" name="form1" method="POST" action="{{ route('mahasantri.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="container">
                            <div class="card">
                                ...
                                <div class="card-body bg-dark-emphasis">
                                    ...
                                    <h4 class="text-center">Studi Materi Pengembangan perangkat Lunak</h4>
                        ...
                        <div class="container">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="text-center">Studi Materi Digital Marketing</h4>
