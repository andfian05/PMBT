...
<div class="content-wrapper">
    ...
    <div class="card card-info">
              ...
              <div class="container">
                            ...
                            <label>Apakah Yang Bersangkutan Mendapat Izin Dari Orang Tua Untuk Mengikuti Beasiswa Pendidikan Pesantren PeTIK Jombang?</label> 
                              <div>
                                <select id="berkas" name="berkas" class="custom-select" required="required">
                                    ...
                                    <option value="30">Tidak, Saya Mengundurkan Diri Dari Program Beasiswa PeTIK Jombang</option>
                            ...
                            <label>Pendidikan Terakhir Kepala Keluarga</label> 
                              <div>
                                <select id="berkas" name="berkas" class="custom-select" required="required">
                                      ...
                                      <option value="80">Sekolah Menengah Atas / Sekolah Menengah Kejuruan / Madrasah Aliyah</option>
                          ...
                          <div class="col-md-6">
                            ...
                            <label>Kepemilikan Harta Tidak Bergerak</label> 
                              <div>
                                <select id="berkas" name="berkas" class="custom-select" required="required">
                                    <option value="">-- Pilihan --</option>
                                    <option value="80">Tanah, Kebun, Sawah, Dan Lainnya (Perkiraan Maksimal 10X UMK) </option>
                                    <option value="70">Tanah, Kebun, Sawah, Dan Lainnya (Perkiraan Maksimal 20X UMK)</option>
                                    <option value="20">Tanah, Kebun, Sawah, Dan Lainnya (Perkiraan Maksimal 30X UMK)</option>
                                    <option value="20">Tanah, Kebun, Sawah, Dan Lainnya (Perkiraan Maksimal 40X UMK)</option>
                                    <option value="20">Tanah, Kebun, Sawah, Dan Lainnya (Perkiraan Maksimal 50X UMK)</option>
                ...
                <div class="col-md-12">
                  <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg" href="{{ url('/admin4') }}">Nilai</a>
                </div>
