...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container">
            <div class="card">
                <div class="card-body">
                  <h4 class="text-center">Penilaian Tes Survei Calon Mahasantri</h4>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                  <form action="{{ route('test-survey.store') }}" method="POST" id="form1" name="form1">
                    @csrf
                            ...
                            <div class="form mb-3 mb-md-0">
                              ...
                              <div>
                                <select name="pendkel" class="custom-select" required>
                                  ...
                                  <option value="10">Sekolah Menengah Atas / Sekolah Menengah Kejuruan / Madrasah Aliyah</option>
                      ...
                      <div class="col-md-12">
                        <button type="submit" class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg">Keputusan Tes Survei</button>
                      </div>
                  </form>
