...
<div class="content-wrapper">
    ...
    <div class="container">
        <div class="card card-info">
            <div class="card-body">
                <form action="{{ route('manage-user.update', $user->id) }}" method="POST" id="form1" name="form1"
                    ...
                    <div class="form-group">
                        ...
                        @empty($user->photo)
                        <img src="{{asset('foto/profile/no-photo.png')}}" style="height: 5rem; margin-top: 1rem;"
                            class="img-circle elevation-2" alt="Image {{ $user->username }}">
                        @else
                        <img src="{{asset('foto/profile')}}/{{ $user->photo }}" style="height: 5rem; margin-top: 1rem;"
                            class="img-circle elevation-2" alt="Image {{ $user->username }}">
                        @endempty
                    </div>
                    <div class="text-center mt-5 mb-5" style="border-radius: 130px;">
                        ...
                        <a class="btn btn-secondary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0"
