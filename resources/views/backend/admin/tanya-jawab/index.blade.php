...
@section('content')
    ...
    <div class="content-wrapper">
      ...
      <div class="container">
        <div class="card">
          <div class="card-body">
            <h5 class="text-center">Data Tes Tanya Jawab Calon Mahasantri</h5>
          </div>
        </div>
      </div>
            ...
            <div class="table-responsive" id="no-more-tables">
              <table class="table">
                ...
                <tbody class="table-group-divider">
                  @php $no = 1 + (($wawancaras->currentPage()-1) * $wawancaras->perPage()); @endphp
              ...
              {!! $wawancaras->appends(Request::except('page'))->render() !!}
            </div>
          </div>
        </div>
      </div>
