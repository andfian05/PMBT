...
<div class="content-wrapper">
    ...
    <div class="container">
        <div class="card card-info">
            <div class="card-body">
                <form action="{{ route('mahasantri.update', $mahasantri->id) }}" method="POST" id="form1" name="form1"
                        ...
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="nama" id="nama" type="text"
                                    value="{{ old('nama') ? old('nama') : $mahasantri->nama }}" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                ...
                                <input class="form-control" name="anak_ke" id="anak_ke" type="text"
                                    value="{{ old('anak_ke') ? old('anak_ke') : $mahasantri->anak_ke }}" />
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="tmp_lahir" type="text"
                                    value="{{ old('tmp_lahir') ? old('tmp_lahir') : $mahasantri->tmp_lahir }}" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                ...
                                <input class="form-control" name="tgl_lahir" type="date"
                                    value="{{ old('tgl_lahir') ? old('tgl_lahir') : $mahasantri->tgl_lahir }}" />
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="no_hp" type="text"
                                    value="{{ old('no_hp') ? old('no_hp') : $mahasantri->no_hp }}" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                ...
                                <input class="form-control" name="email" type="email"
                                    value="{{ old('email') ? old('email') : $mahasantri->email }}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
              ...
              {{ old('alamat') ? old('alamat') : $mahasantri->alamat }}
                            ...
                            <div class="form">
                                ...
                                <div class="form-group -ml-3col-12">
                                    <select name="kab_id" id="kabupaten" class="custom-select">
                                        ...
                                        <option value="{{ $kabupaten->id_kab }}" selected>{{ $kabupaten->nama }}
                                        </option>
                                        @else
                            ...
                            <div class="form mb-3 mb-md-0">
                                ...
                                <div class="form-group -ml-3col-12">
                                    <select name="kec_id" id="kecamatan" class="custom-select">
                                        ...
                                        <option value="{{ $kecamatan->id_kec }}" selected>{{ $kecamatan->nama }}
                                        </option>
                                        @else
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="nama_ayah" type="text"
                            value="{{ old('nama_ayah') ? old('nama_ayah') : $mahasantri->nama_ayah }}" />
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="pkj_ayah" type="text"
                                    value="{{ old('pkj_ayah') ? old('pkj_ayah') : $mahasantri->pkj_ayah }}" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                ...
                                <input class="form-control" name="pdk_ayah" type="text"
                                    value="{{ old('pdk_ayah') ? old('pdk_ayah') : $mahasantri->pdk_ayah }}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input class="form-control" name="nama_ibu" type="text"
                            value="{{ old('nama_ibu') ? old('nama_ibu') : $mahasantri->nama_ibu }}" />
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="pkj_ibu" type="text"
                                    value="{{ old('pkj_ibu') ? old('pkj_ibu') : $mahasantri->pkj_ibu }}" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                ...
                                <input class="form-control" name="pdk_ibu" type="text"
                                    value="{{ old('pdk_ibu') ? old('pdk_ibu') : $mahasantri->pdk_ibu }}" />
                            </div>
                        </div>
                    </div>
                    <div class="row mb-1">
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="jml_sdr" type="text"
                                    value="{{ old('jml_sdr') ? old('jml_sdr') : $mahasantri->jml_sdr }}" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                ...
                                <input class="form-control" name="nohp_klg" type="text"
                                    value="{{ old('nohp_klg') ? old('nohp_klg') : $mahasantri->nohp_klg }}" />
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="skl_asal" type="text"
                            value="{{ old('skl_asal') ? old('skl_asal') : $mahasantri->skl_asal }}" />
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="jurusan_skl" type="text"
                                    value="{{ old('jurusan_skl') ? old('jurusan_skl') : $mahasantri->jurusan_skl }}" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form">
                                ...
                                <input class="form-control" name="thn_lulus" type="text"
                                    value="{{ old('thn_lulus') ? old('thn_lulus') : $mahasantri->thn_lulus }}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
              ...
              {{ old('cita_cita') ? old('cita_cita') : $mahasantri->cita_cita }}
                            ...
                            <div class="form mb-3 mb-md-0">
                                ...
                                <div class="form-group -ml-3col-12">
                                    <select name="jurusan_id" class="custom-select" value="{{ old('jurusan_id') }}">
                                        ...
                                        <option value="{{ $jurusan->id_jurusan }}" selected>{{ $jurusan->nama_jurusan }}
                                        </option>
                                        @else
                  ...
                  {{ old('alasan') ? old('alasan') : $mahasantri->alasan }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group -ml-3col-12">
                            <select name="media_id" class="custom-select" value="{{ old('media_id') }}">
                                ...
                                <option value="{{ $mediaInformasi->id_media }}" selected>
                                    {{ $mediaInformasi->media_informasi }}</option>
                                @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group -ml-3col-12">
                            <select name="metode_berkas" id="metode_berkas" class="custom-select"
                                value="{{ old('metode_berkas') }}" onclick="tampilkan()">
                    ...
                    <div class="text-center mt-5 mb-5" style="border-radius: 130px;">
                        ...
                        <a class="btn btn-secondary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0" href="{{ route('mahasantri.index') }}">
                            Cancel
                        </a>
                    </div>
                </form>
