        ...
        <nav class="navbar navbar-expand-lg mb-5 navbar-light fixed-top shadow-sm" id="mainNav">
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <a class="btn btn-info px-3 mb-2 mb-lg-0 rounded-pill" href="https://startbootstrap.com/theme/new-age"> 
    ...
    <div class="container">
          <div class="card card-info">
              ...
              <div class="card-body">
                  ...
                  @endif
                <!-- Formulir Data Diri -->
                <form action="{{ route('mahasantri.update', $mahasantri) }}" method="POST">
                  @csrf
                  @method('PUT')
                        <div class="form-group">
                          <label for="nama">Nama Lengkap : <span class="text-danger">*</span></label>
                          <input id="nama" name="nama" type="text" class="form-control" value="{{ old('nama', $mahasantri->nama) }}"/>
                        </div>
                        <div class="form-group">
                          <label for="tmp_lahir">Tempat Lahir : </label>
                          <input class="form-control" name="tmp_lahir" id="tmp_lahir" type="text" value="{{ old('tmp_lahir', $mahasantri->tmp_lahir) }}"/>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                              <div class="form mb-3 mb-md-0">
                                <label for="tgl_lahir">Tanggal Lahir : <span class="text-danger">*</span></label>
                                <input class="form-control" name="tgl_lahir" id="tgl_lahir" type="date" value="{{ old('tgl_lahir', $mahasantri->tgl_lahir) }}"/>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form">
                                <label for="anak">Anak Ke-</label>
                                <input class="form-control" name="anak" id="anak" type="text" value="{{ old('anak', $mahasantri->anak) }}"/>
                              </div>
                            </div>                           
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                              <div class="form mb-3 mb-md-0">
                                ...
                                <input class="form-control" name="no_hp" id="no_hp" type="text" value="{{ old('no_hp', $mahasantri->no_hp) }}"/>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form">
                                <label for="email">Email : <span class="text-danger">*</span></label>
                                <input class="form-control" name="email" id="email" type="text" value="{{ old('email', $mahasantri->email) }}"/>
                              </div>
                            </div>                           
                        </div>
                        <div class="form-group">
                          <label>Alamat :</label>
                          <input name="alamat"  class="form-control" id="alamat" value="{{ old('alamat', $mahasantri->alamat) }}" cols="2" rows="2"/>
                        </div>
