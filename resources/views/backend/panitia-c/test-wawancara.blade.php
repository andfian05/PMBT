    ...
    <div class="content-wrapper">
        ...
        <div class="container"> 
            <div class="card card-info">
                ...
                <div class="card-body">
                  <form action="{{ route('test-wawancara.store') }}" method="POST" id="form1" name="form1">
                    @csrf
                      ...
                      <div class="container">
                          <div class="card">
                              <div class="bg-info">
                                  <h6 class="text-center mt-2">Mengucapkan Salam Dan Terima Kasih</h6>
                              </div>
                          </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="text-center mt-5 mb-5" style="border-radius: 130px;">
                          ...
                          <a class="btn btn-success btn-sm-2 px-3 mb-2 mb-lg-0" href="{{ route('test-wawancara.store') }}">
