    ...
    <div class="card card-info">
              ...
              <div class="card-body">
                      ...
                      <div class="row mb-3">
                          <div class="col-md-6">
                            <div class="form mb-3 mb-md-0">
                              ...
                              <textarea name="prestasi"  class="form-control" id="prestasi" cols="2" rows="2"></textarea>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form">
                              <label for="penyakit">Penyakit Yang Pernah Di Derita Jika Tidak Memiliki, Tuliskan ( - ):</label>
                              <textarea name="penyakit"  class="form-control" id="penyakit" cols="2" rows="2"></textarea>
                            </div>
                          </div>                           
                      </div>
                      <div class="form-group">
                ...
                <!-- Tutup Formulir Keseluruhan -->
                  ...
                  <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0" href="{{ url('/pmb2') }}"><i class="fa-solid fa-circle-chevron-left"></i> Kembali&nbsp; </a>
                  <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0" href="{{ url('/pmb4') }}"> Selanjutnya&nbsp; <i class="fa-solid fa-circle-chevron-right"></i></a>
