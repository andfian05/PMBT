            ...
            <img class="navbar-brand" src="{{asset('foto/Petik_YBM2.png' )}}" height="50px" width="149px" alt="">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                        ...
                        <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0 rounded-pill" href="#"> <i class="fa-solid fa-cloud-arrow-down"></i>&nbsp; Download Brosur</a>&nbsp;&nbsp;
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    ...
                    <div class="col-sm-9 col-md-6">
                        ...
                        <p class="lead mb-1 mb-lg-0 text-center">Terimakasih, Anda Telah <b>Berhasil</b> Melakukan Registrasi Pendaftaran Calon Mahasantri Pesantren PeTIK Jombang Tahun Akademik 2023/2024.</p><br>
                        <p class="lead mb-1 mb-lg-0 text-justify">Mohon Menunggu Pengumuman Hasil Seleksi Berkas Pada Tanggal 35 Agustus 2023. Silahkan Masuk Ke Dalam Grup Whatsapp Berikut Ini : <a href="https://www.instagram.com/petik_jombang/" target="_blank">Pendaftar PeTIK Jombang 2023</a> Untuk Melihat Informasi Selanjutnya.</p>
