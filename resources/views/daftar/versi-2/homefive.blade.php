    ...
    <div class="card card-info">
              ...
              <div class="card-body">
                ...
                <form action="#" method="GET">
                        ...
                        <div class="col-13">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="info" id="info_0" type="radio" required="required" class="custom-control-input" value="1"> 
                ...
                <!-- Tutup Formulir Keseluruhan -->
                  ...
                  <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0" href="{{ url('/pmb4') }}"><i class="fa-solid fa-circle-chevron-left"></i> Kembali&nbsp; </a>
                  <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0" href="{{ url('/pmb6') }}"> Selanjutnya&nbsp; <i class="fa-solid fa-circle-chevron-right"></i></a>
