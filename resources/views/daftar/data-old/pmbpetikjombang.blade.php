                ...
                <form action="{{ route('mahasantri.store') }}" method="POST">
                  @csrf
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" name="tmp_lahir" id="tmp_lahir" type="text" value="{{ old('tmp_lahir') }}"/>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                              <div class="form mb-3 mb-md-0">
                                <label for="tgl_lahir">Tanggal Lahir : <span class="text-danger">*</span></label>
                                <input class="form-control" name="tgl_lahir" id="tgl_lahir" type="date" value="{{ old('tgl_lahir') }}"/>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form">
                                <label for="anak">Anak Ke-</label>
                                <input class="form-control" name="anak" id="anak" type="text" value="{{ old('anak') }}"/>
                              </div>
                            </div>                           
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="form-group">
                          <label>Alamat :</label>
                          <input name="alamat"  class="form-control" id="alamat" value="{{ old('alamat') }}" cols="2" rows="2"/>
                        </div>
