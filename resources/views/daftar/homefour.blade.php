                    ...
                    <div class="form-group">
                        ...
                        <div class="col-13 mb-2">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input name="minat" id="minat_0" type="radio" class="custom-control-input" value="ppl"
                                    required="required">
                                <label for="minat_0" class="custom-control-label">Pengembangan Perangkat Lunak
                                    (PPL)</label>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input name="minat" id="minat_1" type="radio" class="custom-control-input" value="dm"
                                    required="required">
