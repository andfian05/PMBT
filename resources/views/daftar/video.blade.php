        ...
        <div class="card card-info">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <iframe width="100%" height="500" src="https://www.youtube.com/embed/8uA_UQqEGUw"
            ...
            <div class="card-body">
                <div class="form-group">
                    <form action="{{ route('register.storeProfil') }}" id="form1" name="form1" method="POST" id="form1" name="form1" enctype="multipart/form-data">
                    @csrf
                        <div class="form-group">
                            <label for="keterangan">Apakah anda sudah mengetahui gambaran mengenai Pesantren PeTIK
                                Jombang, dan yakin untuk melakukan pendaftaran?</label>
                                ...
                                if (pesan == "sm") {
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="keterangan" class="form-control" id="" cols="12" rows="6" required="required"></textarea>
                                        </div>                   
                                    </div>
                                    <div class="form-group">
                                        <div class="col-12">
                                            <button class="btn btn-primary" type="submit">Memulai Mengisi</button>
                                        </div>
                                    </div>`;
                                } else if (pesan == "bm") {
                                    p_kontainer.innerHTML =
