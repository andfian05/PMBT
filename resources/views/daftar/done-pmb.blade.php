  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg mb-5 navbar-light fixed-top shadow-sm" id="mainNav">
      <div class="container px-5">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive"></ul>
          ...
          <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0 rounded-pill"
            href="{{ url('/') }}"> <i class="fa-solid fa-bookmark"></i>&nbsp; Panduan Informasi
          </a>
        </div>
      </div>
    </nav>
          ...
          <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
            ...
            <div class="col-sm-9 col-md-6">
              ...
              <p class="lead mb-1 mb-lg-0 text-justify">Mohon Menunggu Pengumuman Hasil Seleksi Berkas Pada
                Tanggal 35 Agustus 2023. Silahkan Masuk Ke Dalam Grup Whatsapp Berikut Ini : 
                <a href="https://www.instagram.com/petik_jombang/" target="_blank">Pendaftar PeTIK Jombang 2023</a> Untuk Melihat Informasi Selanjutnya.
              </p>
            </div>
          </div>
        </div>
