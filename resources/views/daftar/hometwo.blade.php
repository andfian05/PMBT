    ...
    <div class="card card-info">
              ...
              <div class="card-body">
                ...
                <!-- Tutup Formulir Keseluruhan -->
                  ...
                  <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0" href="{{ url('/pmb1') }}"><i class="fa-solid fa-circle-chevron-left"></i> Kembali&nbsp; </a>
                  <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0" href="{{ url('/pmb3') }}"> Selanjutnya&nbsp; <i class="fa-solid fa-circle-chevron-right"></i></a>
