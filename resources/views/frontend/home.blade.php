        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                    ...
                    <li><a class="nav-link me-lg-3" href="https://petik-jombang.vercel.app" target="_blank">Profil PeTIK
                            Jombang</a></li>
                ...
                <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0 rounded-pill"
                    href="https://petikjombang.com/" target="_blank"> <i
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <a class="btn btn-primary bg-gradient-primary-to-secondary px-3 mb-2 mb-lg-0 rounded-pill"
                        href="https://petikjombang.com/" target="_blank"> <i class=""></i>&nbsp;Daftar Sekarang</a>
                </div>
                <div class="col-lg-6">
                    <!-- video tutorial-->
                            ...
                            <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                <div class="screen bg-black">
                                    ...
                                    <video muted="muted" autoplay="" loop="" style="max-width: 100%; height: 100%">
                                        <source src="{{asset('assets2/assets/img/demo-screen.mp4')}}"
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-12">
                    <div class="h5 fs-1 text-white mb-4">
                        <h5>"Pencetak Mahasantri Dengan Ahli Ilmu Teknologi Terbaik Yang Berakhlak Mulia."</h5>
                    </div>
            ...
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                <div class="col-12 col-lg-5 mb-5">
                    ...
                    <p class="lead mb-5 mb-lg-0">Syarat dan Ketentuan Calon Mahasantri Pesantren PeTIK Jombang sebagai
                        berikut :</p><br>
                    <ul>
                        <li><b>Antusias Tinggi</b>, untuk mengeyam pendidikan untuk mempelajari ilmu agama dan dunia
                            teknologi.</li>
                        <li>Berasal dari<b>Keluarga dengan Perekonomian Terbatas</b>(Dhuafa).</li>
                        <li>Dikhususkan untuk <b>Lelaki Muslim</b> dengan lulusan <b>Sekolah Menegah Atas (SMA) maupun
                                sederajat</b> lulusan tahun angkatan <b>2021,2022,2023</b> .</li>
            ...
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                ...
                <div class="col-sm-9 col-md-6">
                    ...
                    <ul>
                        ...
                        <li><b>Salinan Ijazah Sekolah Menengah Atas (SMA)</b> maupun sederajat atau <b> Surat Keterangan
                                Aktif (SMA/SMK/Aliyah)</b> dari pihak Sekolah (Jika belum memiliki ijazah).</li>
            ...
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                <div class="col-12 col-lg-5 mb-5">
                    ...
                    <ul>
                        ...
                        <li>Mengisi formulir pendaftaran secara online dengan akses link
                            <b>pmbt.petikjombang.com</b>atau dengan melalui 2 cara :
                            <ul>
                                <li>Upload berkas secara online dalam bentuk <b>scan format (JPG / PNG / PDF)</b>
                                    melalui link akses <b>pmbt.petikjombang.com</b> atau menggunakan via <b>email :
                                        petikjombang@gmail.com</b> .</li>
                        ...
                        <li>Calon Mahasantri yang sudah mengisi formulir pendaftaran akan dimasukkan ke dalam grup
                            Whatsapp <b>“Pendaftar PeTIK 2023”</b> .</li>
                        <li><b>Verifikasi Panitia</b> , Panitia akan mengumumkan hasil seleksi melalui website dan grup
                            Whatsapp.</li>
                        <li><b>Batas pengisian formulir dan penyerahan berkas</b> persyaratan paling lambat tanggal 30
                            Juni 2023.</li>
                        <li>Pendaftaran terbagi menjadi dua gelombang, pada gelombang pertama dilakukan pada tanggal
                            <b>1 Januari 2023 - 15 Maret 2023</b> . Pada gelombang kedua akan dilakukan pada tanggal
            ...
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                ...
                <div class="col-sm-9 col-md-6">
                    ...
                    <p class="lead mb-5 mb-lg-0">Siapkan berkas persyaratan dan Silahkan isi formulir pendaftaran dalam
                        link <b>pmbt.petikjombang.com</b></p>
                    <br>
                    <p class="lead mb-5 mb-lg-0"><b>Catatan</b> :
                        ...
                        kemudian kirimkan berkas tersebut.</p>
                    <br>
                    <p class="lead mb-5 mb-lg-0"> Formulir Pendaftaran : PMBT Pesantren PeTIK akan ditutup pada tanggal
                        <b>30 Juni 2023</b></p>
