                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                        ...
                        <li ><a class="nav-link me-lg-3" href="#pendaftaran">Pendaftaran</a></li>
                            ...
                            <a class="btn btn-primary bg-gradient-primary-to-secondary  px-3 mb-2 mb-lg-0 rounded-pill" href="https://drive.google.com/file/d/1W5RBTcG5ZQ4cN9PGm5jQloQRkNMBnAnW/view" target="_blank"> <i class="fa-solid fa-cloud-arrow-down"></i>&nbsp;Download Brosur</a>
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    <div class="col-12 col-lg-5 mb-5">
                        ...
                        <p class="lead mb-5 mb-lg-0">Syarat dan Ketentuan Calon Mahasantri PeTIK Jombang sebagai berikut :</p><br>
                        <ul>
                            ...
                            <li>Dikhususkan untuk <b>Laki-Laki Muslim</b> dengan lulusan <b>(SMA / SMK / MA)</b> tahun angkatan <b>2021,2022,2023</b> .</li>
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    <div class="col-12 col-lg-5 mb-5">
                        ...
                        <p class="lead mb-5 mb-lg-0">Alur pendaftaran Calon Mahasantri PeTIK Jombang sebagai berikut :</p><br>
                        <ul>
                            <li>Siapkan berkas-berkas persyaratan yang telah ditentukan.</li>
                            <li>Mengisi formulir pendaftaran secara online dengan akses Link <a href="http://pmb.petikjombang.com/">pmb.petikjombang.com</a> atau dengan melalui 2 cara :
                                <ul>
                                    <li>Upload berkas secara online dalam bentuk format<b>(JPG / PNG / PDF)</b>, lalu disatukan menjadi format <b>(ZIP atau RAR)</b> dengan nama folder<b>(Nama_Lengkap)</b>  melalui link akses <a href="http://pmb.petikjombang.com/">pmb.petikjombang.com</a>  atau menggunakan via Email : <b>pmb.petikjombang@gmail.com</b> .</li>
                                    <li>Atau bisa kirim dengan kurir atau datang langsung ke alamat ini <b>Pesantren Teknologi Informasi Dan Komunikasi YBM PLN, Jl. KH. Bisri Syansuri RT.01/RW.05, Plosogeneng, Kec. Jombang, Jombang, Jawa Timur 61416</b>.</li>                             
                                </ul>
                            </li>
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    ...
                    <div class="col-sm-9 col-md-6">
                        ...
                        <p class="lead mb-5 mb-lg-0">Siapkan berkas persyaratan dan silahkan isi formulir pendaftaran dalam link <b><a href="{{ url('/pmbpetikjombang') }}" target="_blank">pmb.petikjombang.com</a></b>.</p>
                        <br>
                        <p class="lead mb-5 mb-lg-0"><b>Catatan</b>  :
                        Bagi yang akan mengirimkan berkas via online maka diharapkan menyiapkan semua berkas yang dibutuhkan terlebih dahulu dalam bentuk (JPG / PNG / PDF) lalu disatukan menjadi format (ZIP atau RAR) dengan nama folder (Nama_Lengkap) sebelum mengisi formulir. Bagi yang akan mengirimkan berkas via email atau jasa kirim maka diwajibkan mengisi formulir terlebih dahulu dan upload foto bukti pengiriman untuk pada formulir, Kemudian kirimkan berkas tersebut pada alamat Pesantren.</p>
                        <br>
                        <p class="lead mb-5 mb-lg-0"> Formulir pendaftaran : PMB PeTIK Jombang akan ditutup pada tanggal <b>30 Juni 2023</b>.</p>
