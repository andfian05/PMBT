...
class Mahasantri extends Model
{
    ...
    protected $fillable = [
        'nama', 'profil_id', 'anak_ke', 'tmp_lahir', 'tgl_lahir', 'no_hp', 'email', 'alamat', 'prov_id', 'kab_id', 'kec_id', 'desa_id', 'nama_ayah', 'pkj_ayah', 'pdk_ayah', 'nama_ibu', 'pkj_ibu', 'pdk_ibu', 'jml_sdr', 'nohp_klg', 'skl_asal', 'jurusan_skl', 'thn_lulus', 'cita_cita', 'prestasi', 'penyakit', 'perokok', 'jurusan_id', 'alasan', 'media_id',  'metode_berkas', 'berkas'
    ];
